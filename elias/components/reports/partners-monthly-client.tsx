    ...
    <div className="space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-muted">
          Gera um DOCX com as atualizações do mês (baseado no campo <code>updated_at</code>).
        </p>
      </header>
      ...
      <section className="rounded-lg border border-border bg-surface p-4 space-y-3">
        ...
        <div className="text-xs text-muted">
          Dica: se não aparecer nada, é porque não houve alterações nesse mês (ou você ainda não rodou o SQL de
          catálogo).
        </div>
      </section>
